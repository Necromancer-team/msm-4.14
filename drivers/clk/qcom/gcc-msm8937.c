...
static struct clk_alpha_pll gpll3_out_main = {
	.offset = 0x22000,
	.flags = SUPPORTS_SLEW,
	.vco_table = gpll3_vco_8917,
	.num_vco = ARRAY_SIZE(gpll3_vco_8917),
	.clkr = {
		.hw.init = &(struct clk_init_data){
			.name = "gpll3_out_main",
			.parent_names = (const char *[]){ "bi_tcxo" },
...
static const struct qcom_cc_desc gcc_msm8937_desc = {
	...
	.hwclks = gcc_msm8937_hws,
	.num_hwclks = ARRAY_SIZE(gcc_msm8937_hws),
...
static void fixup_for_msm8937(struct platform_device *pdev,
	struct regmap *regmap)
{
	cpp_clk_src.freq_tbl = ftbl_cpp_clk_src_8937;
	cpp_clk_src.clkr.hw.init->rate_max[VDD_LOW] = 160000000;
	cpp_clk_src.clkr.hw.init->rate_max[VDD_LOW_L1] = 266670000;
	cpp_clk_src.clkr.hw.init->rate_max[VDD_NOMINAL] = 320000000;
	...
	gfx3d_clk_src.freq_tbl = ftbl_oxili_gfx3d_clk_src_8937;
	...
	gpll3_out_main.vco_table = gpll3_vco_8937;
	gpll3_out_main.num_vco = ARRAY_SIZE(gpll3_vco_8937);
...
static void fixup_for_msm8917_gcc_mdss(void)
{
	/*
	 * Below clocks are not available on MSM8917, thus mark them NULL.
	 */
...
static const struct of_device_id mdss_msm8937_match_table[] = {
	...
	{ .compatible = "qcom,gcc-mdss-msm8917" },
	{}
};
